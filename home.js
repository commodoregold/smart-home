...
function HomeScreen() {
  ...
  function LED1() {
    if (led1status == 1) {
      ...
      setled1Image(ledoff)
      fetch('http://192.168.36.35/lightoff')
      ...
      setled1Image(ledon)
      fetch('http://192.168.36.35/lighton')
        .then((response) => response.json())
        .then((data) => console.log(data));
    }
  ...
  function LED2() {
    if (led2status == 1) {
      ...
      fetch('http://192.168.36.35/light1off')
        .then((response) => response.json())
        .then((data) => console.log(data));
    }
    else {
      ...
      console.log('Light on')
      setled2Image(led1on)
      fetch('http://192.168.36.35/light1on')
        .then((response) => response.json())
        .then((data) => console.log(data));
    }
  ...
  function LED3() {
    if (led3status == 1) {
      ...
      fetch('http://192.168.36.35/light2off')
        .then((response) => response.json())
        .then((data) => console.log(data));
    }
    else {
      ...
      console.log('Light on')
      setled3Image(led2on)
      fetch('http://192.168.36.35/light2on')
        .then((response) => response.json())
        .then((data) => console.log(data));
    }
